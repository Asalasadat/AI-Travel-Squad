...
class _PreferencesScreenState
  ...
  // المدن (العربي للعرض - الإنجليزي للإرسال)
  ...
  // أنواع الرحلات
  final Map<String, String> tripTypes = {
    'ديني': 'Religious',
    'ثقافي': 'Cultural',
    'مغامرة': 'Adventure',
    'عائلي': 'Family',
  ...
  // الفئات العمرية حسب الـ Backend
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed:
                        loading ? null : continueToResults,
                ...
                const Center(
                  child: Text(
                    'اكتشف فلسطين مع "AI Travel Squad"',
                    style: TextStyle(
                      color: Colors.grey,
                    ),
                  ),
...
Widget _buildTripTypes() {
  return Wrap(
    spacing: 8,
    runSpacing: 8,
    children: tripTypes.keys.map((type) {
      final selected = selectedTripTypes.contains(type);
